...
if __name__ == '__main__': 
    ...
    for file in process_files: 
        print("Processing file: " + import_directory+file)
        file_name = file.split(".")[0]

        tokenizer = JackTokenizer(import_directory+file)
        engine = JackCompilationEngine(import_directory+file_name, tokenizer)
        engine.process()

        print("end compiling of " + import_directory+file)
